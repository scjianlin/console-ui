...
export default {
  Workspace: '集群管理',
  Workspaces: '集群管理',
  'Workspace Settings': '集群管理',
  'Workspace Members': '集群成员',
  'Workspace Roles': '集群角色',
  'Workspace Role': '集群角色',
  'Workspace Name': '集群名称',
  'Workspace Logo': '集群 Logo',
  'Workspace Manager': '集群管理员',
  'Workspaces Manager': '集群管理员',
  'Create Workspace': '创建集群',
  'Enter Workspace': '进入集群',
  ...
  WORKSPACE_SEARCH_PLACEHOLDER: '请输入集群名称进行查找',
  ...
  WORKSPACE_ROLE_DESC: '集群色定义了在当前集群下用户所拥有的权限。',
  ...
  'Please input workspace name': '请输入集群名称',
